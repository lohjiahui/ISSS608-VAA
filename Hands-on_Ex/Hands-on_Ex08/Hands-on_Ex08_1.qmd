...
```{r}
popdata <- read_csv("data/respopagesextod2011to2020/respopagesextod2011to2020.csv")
```
...
#### 4.2.4 **Data classification methods of tmap**
...
##### 4.2.4.1 Plotting choropleth maps with built-in classification methods
...
##### 4.2.4.2 Plotting choropleth map with custom break
...
### 4.2.5.1 Using ColourBrewer palette
...
Notice that the colour scheme has been reversed for the green chart, when you add a '-' before the colour.
...
#### 4.2.6.3 Cartographic Furniture
...
### 4.2.7 **Drawing Small Multiple Choropleth Maps**
...
#### 4.2.7.1 By assigning multiple values to at least one of the aesthetic arguments
...
#### 4.2.7.2 By defining a group-by variable in *tm_facets()*
...
#### 4.2.7.3 By creating multiple stand-alone maps with *tmap_arrange()*
...
### 4.2.8 **Mappping Spatial Object Meeting a Selection Criterion**
