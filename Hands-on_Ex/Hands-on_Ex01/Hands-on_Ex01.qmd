...
###### ![](image4.jpg)Reference: Hadley Wickham (2010) "A layered grammar of graphics." Journal of Computational and Graphical Statistics, vol. 19, no. 1, pp. 3--28.
...
scale_y\_continuous() is used to turn off the y-axis, and binwidth argument is used to change the binwidth to 2.5.
:::
...
s 3 Programming Interactive Data Visualisation with R 4 Programming Animated Statistical Graphics with R Not So Common Chart 5 Visualising Likert Scale Data with Divergining Stacked Bar Chart 6 Visual Correlation Analysis of Numerical and Categorical Data 7 R for Data Science: Tidyverse principles and methods 8 R for Data Science: Tidyverse principles and methods Visual Analytics 9 Visual Statistical Analysis 10 Visualising Uncertainty 11 Funnel Plots for Fair Comparisons 12 R for Data Science: Tidyverse principles and methods Visualising and Analysing Multivariate Data 13 Creating Ternary Plot with R 14 Heatmap for Visualising and Analysing Multivariate Data 15 Visual Multivariate Analysis with Parallel Coordinates Plot 16 Treemap Visualisation with R Visualising and Analysing Time-series Data 17 R for Data Science: Tidyverse principles and methods 18 R for Data Science: Tidyverse principles and methods 19 R for Data Science: Tidyverse principles and methods 20 R for Data Science: Tidyverse principles and methods Visualising and Analysing Geographical Data 21 R for Data Science: Tidyverse principles and methods 22 R for Data Science: Tidyverse principles and methods 23 R for Data Science: Tidyverse principles and methods 24 R for Data Science: Tidyverse principles and methods Visualising and Analysing Spatio-temporal Data 25 R for Data Science: Tidyverse principles and methods 26 R for Data Science: Tidyverse principles and methods Visualising and Analysing Network Data 27 R for Data Science: Tidyverse principles and methods 28 R for Data Science: Tidyverse principles and methods Visualising and Analysing Text Data 29 R for Data Science: Tidyverse principles and methods 30 R for Data Science: Tidyverse principles and methods Information Dashboard Design with R 31 R for Data Science: Tidyverse principles and methods 32 R for Data Science: Tidyverse principles and methods 33 Summary References Table of contents

1.1 Learning Outcome 1.2 Getting started 1.3 Introducing ggplot 1.4 Grammar of Graphics 1.5 Essential Grammatical Elements in ggplot2: data 1.6 Essential Grammatical Elements in ggplot2: Aesthetic mappings 1.7 Essential Grammatical Elements in ggplot2: geom 1.8 Essential Grammatical Elements in ggplot2: stat 1.9 Essential Grammatical Elements in ggplot2: Facets 1.10 Essential Grammatical Elements in ggplot2: Coordinates 1.10.1 Working with Coordinate 1.10.2 Changing the y- and x-axis range 1.11 Essential Grammatical Elements in ggplot2: themes 1.12 Reference 1 A Layered Grammar of Graphics: ggplot2 methods PUBLISHED December 4, 2023 MODIFIED April 14, 2023 1.1 Learning Outcome
...
1.2.1 Installing and loading the required libraries Before we get started, it is important for us to ensure that the required R packages have been installed. If yes, we will load the R packages. If they have yet to be installed, we will install the R packages and load them onto R environment.

Note The code chunk on the right assumes that you already have pacman package installed. If not, please go ahead install pacman first.

pacman::p_load(tidyverse)

1.2.2 Importing data The code chunk below imports exam_data.csv into R environment by using read_csv() function of readr package.
...
The categorical attributes are: ID, CLASS, GENDER and RACE. The continuous attributes are: MATHS, ENGLISH and SCIENCE. 1.3 Introducing ggplot
...
For more detail, visit ggplot2 link. 1.3.1 R Graphics VS ggplot First, let us compare how R Graphics, the core graphical functions of Base R and ggplot plot a simple histogram.

R Graphics ggplot2 ggplot(data=exam_data, aes(x = MATHS)) + geom_histogram(bins=10, boundary = 100, color="black", fill="grey") + ggtitle("Distribution of Maths scores")
...
scale_y\_continuous() is used to turn off the y-axis, and binwidth argument is used to change the binwidth to 2.5. ggplot(data=exam_data, aes(x = MATHS)) + geom_dotplot(binwidth=2.5,\
dotsize = 0.5) +\
...
bins argument is used to change the number of bins to 20, fill argument is used to shade the histogram with light blue color, and color argument is used to change the outline colour of the bars in black ggplot(data=exam_data, aes(x= MATHS)) + geom_histogram(bins=20,\
color="black",\
fill="light blue")

## 1.7.5 Modifying a geometric object by changing aes()

The code chunk below changes the interior colour of the histogram (i.e. fill) by using sub-group of aesthetic(). ggplot(data=exam_data, aes(x= MATHS, fill = GENDER)) + geom_histogram(bins=20, color="grey30")
...
frequency of values of a variable (bar graph) a mean a confidence limit There are two ways to use these functions: add a stat\_() function and override the default geom, or add a geom\_() function and override the default stat. 1.8.1 Working with stat() The boxplots below are incomplete because the positions of the means were not shown.
...
ggplot(data=exam_data, aes(y = MATHS, x= GENDER)) + geom_boxplot() + stat_summary(geom = "point",\
fun.y="mean",\
colour ="red",\
size=4)
...
ggplot(data=exam_data, aes(y = MATHS, x= GENDER)) + geom_boxplot() + geom_point(stat="summary",\
fun.y="mean",\
colour ="red",\
size=4)
...
ggplot(data=exam_data, aes(x= MATHS, y=ENGLISH)) + geom_point() + geom_smooth(size=0.5)

Note The default method used is loess. The default smoothing method can be overridden as shown below.
...
-   Learning ggplot2 on Paper -- [Components Learning](https://henrywang.nl/learning-ggplot2-on-paper-components/)

-   ggplot2 on Paper -- [Layer Learning](https://henrywang.nl/learning-ggplot2-on-paper-layer/)

-   ggplot2 on Paper -- [Scale](https://henrywang.nl/tag/learning-ggplot2-on-paper/)
