...
In this hands-on exercise, we will learn how to model, analyse and visualise network data using R. By the end of this hands-on exercise, we will be able to:
...
![](/images/activate.jpeg)

-   In the above the *.N()* function is used to gain access to the node data while manipulating the edge data. Similarly *.E()* will give you the edge data and *.G()* will give you the **tbl_graph** object itself.

### 5.3 Using `tbl_graph()` to build tidygraph data model.
...
### 5.5 Changing the active object
...
![](/images/ggraphlayouts.png)

![](/images/ggraphlayout2.png)

### 6.5 Fruchterman and Reingold layout
...
#### 6.8.1 Working with facet_edges()
...
#### 6.8.2 Working with facet_edges()
...
#### 6.8.3 Working with facet_nodes()
